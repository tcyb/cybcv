...
\textbf{Publications}
\begin{innerlist}
	\item Have a first-author research publication in field-relevant computational neuroscience journal. Another manuscript under review at a flagship computational biology journal
	\item Several first-author research manuscripts are currently in preparation, and I have contributed to several research publications as middle author.
\end{innerlist}
\textbf{Presentations \& Conferences}
\begin{innerlist}
	\item Have presented research posters at the Society for Neuroscience annual meeting and the Gordon Research Conference on bioanalytical sensors, as well as a number of Northwestern colloquia.
	\item Have also presented at the American Association of Medical Colleges' annual meeting regarding volunteer work.
\end{innerlist}
...
\item[] \textit{Director, \href{http://www.feinberg.northwestern.edu/sites/mstp/about-us/prism/index.html}{PRISM}}
	...
	\item Organized and ran bi-weekly mentoring sessions for ten mentors and over twenty students at the Chicago McCormick Boys and Girls Club
	\end{innerlist}
...
\begin{innerlist}
\item Regularly use Python, along with the Biopython, PyMC, Keras, ScikitLearn packages
\item Regularly use Matlab with GPU, parallel toolkits,  have worked extensively with Mathematica and SQL
...
\item Have achieved Competition Contributor rank on Kaggle, active on Project Euler programming challenges
