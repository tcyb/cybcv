...
\section{Summary}
I am a computationally-focused M.D./Ph.D. candidate looking to make small dents in big questions in human health. I am currently searching for research-focused internships and other opportunities to explore the intersections of medicine and health, biotechnology, and data science.
...
\item[] M.D. Candidate, Feinberg School of Medicine
...
\hfill \textbf{March 2011 - Current}
	\begin{innerlist}
	\item Designed parallel dynamic algorithms to analyze the performance of DNA-based molecular recorders, implemented on GPUs
...
%\begin{innerlist}
%\item Investigated cold-responsive motifs in the \textit{A. Thaliana} genome using ontology and expression data \textit{via} clustering approaches
%\end{innerlist}
%\end{outerlist}
...
\textbf{Publications}
\begin{innerlist}
	\item Authorship on several research publications, including a first-author manuscript at a computational neuroscience journal
	\item Several first-author research manuscripts are currently either in preparation or under review at research journals
\end{innerlist}
\textbf{Presentations \& Conferences}
\begin{innerlist}
	\item Presented research posters at the Society for Neuroscience annual meeting and the Gordon Research Conference on bioanalytical sensors, as well as a number of Northwestern colloquia.
	\item Presented at the American Association of Medical Colleges' annual meeting regarding volunteer work.
\end{innerlist}
...
%	\item Cybulski TR, Kording KP. Nucleotide-time Alignment for Molecular Ticker Tapes. \textit{In preparation.}
%\end{bibenum}
%
...
\begin{innerlist}
\item Collaborated with a fellow graduate student to create neuroscience-based curriculum and experiments for one-day teaching workshop
...
\item[] \textit{Director, \href{http://www.feinberg.northwestern.edu/sites/mstp/about-us/prism/index.html}{PRISM}}
	...
	\begin{innerlist}
	\item Organized construction of medical- and science-centric curriculum, directing multiple teams while creating and reviewing content
	\item Conducted bi-weekly mentoring sessions for ten mentors and over twenty students at the Chicago McCormick Boys and Girls Club
	\end{innerlist}
...
%	
%	\begin{innerlist}
%	\item Interviewed, reviewed applicants to the Northwestern MSTP
...
\begin{innerlist}
\item Regularly use Python, along with the Numpy, Matplotlib, Biopython, PyMC, Keras, ScikitLearn packages
\item Regularly use Matlab with GPU, parallel toolkits,  have worked extensively with Mathematica
\item Regularly use \LaTeX{} typsetting, Adobe Illustrator, Microsoft and Google productivity software
\end{innerlist}

\textbf{Conceptual Skills}
\begin{innerlist}
\item Dynamic programming, machine learning, bioinformatics, probabilistic graphical models, Bayesian statistics
\end{innerlist}

\textbf{Memberships}
\begin{innerlist}
\item Society for Neuroscience, American Physician-Scientist Association, Tau Beta Pi
\end{innerlist}

\textbf{Activities}
\begin{innerlist}
\item Oversaw dance troupes with almost two-hundred members in college, have danced semi-professionally in Chicago
\item Curated library of thousands of records as Assistant Music Director for CHIRP Radio in Chicago, held a regular show as DJ for several years
\item Have achieved Competition Contributor rank on Kaggle, active in Project Euler programming challenges
\item Avid chef, proficient in several modernist techniques
\end{innerlist}
